...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="ClipTree" Height="480" Width="440" 
        ...
        <Grid Margin="40">
            ...
            <Grid Grid.Row="1">
                ...
                <StackPanel Name="UsagePanel" Visibility="Collapsed">
                    ...
                    <TextBlock Text="Aliases: ct, cliptree" FontSize="13" Foreground="#555555" />
                </StackPanel>
            </Grid>
...
$InstallBtn.Add_Click({
    ...
    try {
        if (-not (Test-Path $CurrentScriptPath)) { throw "ClipTree.ps1 not found." }
        ...
        $CleanContent = (Get-Content $PROFILE -ErrorAction SilentlyContinue) | Where-Object { $_ -notlike "*ClipTree.ps1*" }
